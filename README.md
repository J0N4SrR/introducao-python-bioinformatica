...
* **Análise de Dados Estruturados**: Manipulação de tabelas, carregamento de planilhas de mercado e estatística descritiva com Pandas (Aula 06).
...
A organização do material segue uma progressão de complexidade:
...
* **`/aulas`**: Notebooks interativos (.ipynb) contendo:
    ...
    * **Aula06**: Manipulação de tabelas de dados, inspeção e agregação estatística (Pandas).
* **`/exercicios`**: Listas de fixação baseadas em casos reais (Cálculo de IMC, Manchester e análise de fragmentos).
* **`/data`**: Conjuntos de dados simulados utilizados nas práticas (sequências FASTA, planilhas mockadas e bancos de pacientes).
...
* **Python 3.x**: Linguagem base para o desenvolvimento das análises.
* **Jupyter Notebooks**: Ambiente de desenvolvimento iterativo utilizado nas aulas.
* **Pandas & NumPy**: Manipulação de volumes de dados clínicos e estruturação de tabelas.
* **Biopython**: Ferramentas para análise de sequências biológicas.
...
Sou Engenheiro de Software, Biomédico e Mestre em Ciências da Saúde, com experiência em análises laboratoriais, tecnologia e desenvolvimento de soluções aplicadas à saúde.

* **LinkedIn**: [jonas-ribeiro-da-rosa](https://www.linkedin.com/in/jonas-ribeiro-da-rosa)
* **Currículo Lattes**: [Plataforma Lattes](https://lattes.cnpq.br/4668038235896743)
